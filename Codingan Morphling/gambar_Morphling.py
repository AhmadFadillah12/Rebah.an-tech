...
Gambar_Dino_Nunduk =   [pygame.image.load('Gambarrr/Dino/Dino Nunduk/Proses Nunduk1.png'),
                        pygame.image.load('Gambarrr/Dino/Dino Nunduk/Proses Nunduk2.png'),
                        pygame.image.load('Gambarrr/Dino/Dino Nunduk/Proses Nunduk3.png'),
                        pygame.image.load('Gambarrr/Dino/Dino Nunduk/Proses Nunduk4.png'),]
...
Gambar_Ptero = [pygame.image.load('Gambarrr/Ptero/Pterodactyl1.png'),
                pygame.image.load('Gambarrr/Ptero/Pterodactyl2.png'),
                pygame.image.load('Gambarrr/Ptero/Pterodactyl3.png'),
                pygame.image.load('Gambarrr/Ptero/Pterodactyl4.png'),
                pygame.image.load('Gambarrr/Ptero/Pterodactyl5.png'),
                pygame.image.load('Gambarrr/Ptero/Pterodactyl6.png'),
                pygame.image.load('Gambarrr/Ptero/Pterodactyl7.png'),
                pygame.image.load('Gambarrr/Ptero/Pterodactyl8.png'),]
