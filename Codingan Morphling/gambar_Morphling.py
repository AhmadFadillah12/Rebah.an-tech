...
Gambar_Dino_Nunduk       = [pygame.image.load(f'Codingan Morphling/Gambarrr/Dino/Dino Nunduk/Proses Nunduk{i+1}.png')         for i in range (0,4) ]
Gambar_Dino_Lari         = [pygame.image.load(f'Codingan Morphling/Gambarrr/Dino/Dino Lari/Run ({i+1}).png')                  for i in range (0,8) ]
Gambar_Dino_Melompat     = [pygame.image.load(f"Codingan Morphling/Gambarrr/Dino/Dino Lompat/Jump ({i+1}).png")               for i in range(0,12) ]

Gambar_Dino_Awal_evo     =    pygame.image.load('Codingan Morphling/Gambarrr/dino_idle.png')
Gambar_Dino_Nunduk_evo   = [pygame.image.load(f'Codingan Morphling/Gambarrr/Dino/Evolusi/Dino Nunduk/Proses Nunduk{i+1}.png') for i in range (0,4) ]
Gambar_Dino_Lari_evo     = [pygame.image.load(f'Codingan Morphling/Gambarrr/Dino/Evolusi/Dino Lari/Run ({i+1}).png')          for i in range (0,8) ]
Gambar_Dino_Melompat_evo = [pygame.image.load(f'Codingan Morphling/Gambarrr/Dino/Evolusi/Dino Lompat/Jump ({i+1}).png')       for i in range (0,12)]
Gambar_Obstacle_Batu     = [pygame.image.load(f'Codingan Morphling/Gambarrr/Batu/Crystal{i+1}.png')                           for i in range (0,13)]
Gambar_Ptero             = [pygame.image.load(f'Codingan Morphling/Gambarrr/Ptero/pterodactyl{i+1}.png')                      for i in range (0,8) ]
